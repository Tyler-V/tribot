...
/**
 * The Images class contains helper methods for getting images along with other utilities relating to images.
 *
 * @author Nolan
 */
public class Images {
     ...
     *
     * @param url The url to get the image icon from.
     * @return The image icon retrieved.
