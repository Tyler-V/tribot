...
/**
 * Represents a JSON value. This can be a JSON <strong>object</strong>, an <strong> array</strong>, a <strong>number</strong>, a <strong>string</strong>, or one
 * of the literals
 * <strong>true</strong>, <strong>false</strong>, and <strong>null</strong>.
 *
 * The literals <strong>true</strong>, <strong>false</strong>, and <strong>null</strong> are represented by the constants {@link #TRUE}, {@link #FALSE}, and
 * {@link #NULL}.
 * </p>
 *
 * JSON <strong>objects</strong> and <strong>arrays</strong> are represented by the subtypes {@link JsonObject} and {@link JsonArray}. Instances of these types
 * can be created using the public constructors of these classes.
 * </p>
 *
 * Instances that represent JSON <strong>numbers</strong>, <strong>strings</strong> and
 * <strong>boolean</strong> values can be created using the static factory methods {@link #valueOf(String)}, {@link #valueOf(long)}, {@link #valueOf(double)},
 * etc.
 * </p>
 *
...
public abstract class JsonValue implements Serializable {
     ...
     * @throws ParseException if the input is not valid JSON
     */
    public static JsonValue readFrom(String text) throws IOException {
    ...
    /**
     * Detects whether this value represents a JSON object. If this is the case, this value is an instance of {@link JsonObject}.
     *
    ...
    /**
     * Detects whether this value represents a JSON array. If this is the case, this value is an instance of {@link JsonArray}.
     *
     ...
     *
     * @return <code>true</code> if this value represents either the JSON literal <code>true</code> or <code>false</code>
     */
    ...
    /**
     * Returns this JSON value as an <code>int</code> value, assuming that this value represents a JSON number that can be interpreted as Java <code>int</code>.
     * If this is not the case, an exception is thrown.
     *
     * To be interpreted as Java <code>int</code>, the JSON number must neither contain an exponent nor a fraction part. Moreover, the number must be in the
    ...
    /**
     * Returns this JSON value as a <code>long</code> value, assuming that this value represents a JSON number that can be interpreted as Java
     * <code>long</code>. If this is not the case, an exception is thrown.
     *
     * To be interpreted as Java <code>long</code>, the JSON number must neither contain an exponent nor a fraction part. Moreover, the number must be in the
    ...
    /**
     * Returns this JSON value as a <code>float</code> value, assuming that this value represents a JSON number. If this is not the case, an exception is
     * thrown.
     *
     * If the JSON number is out of the <code>Float</code> range, {@link Float#POSITIVE_INFINITY} or {@link Float#NEGATIVE_INFINITY} is returned.
     * </p>
     *
    ...
    /**
     * Returns this JSON value as a <code>double</code> value, assuming that this value represents a JSON number. If this is not the case, an exception is
     * thrown.
     *
     * If the JSON number is out of the <code>Double</code> range, {@link Double#POSITIVE_INFINITY} or {@link Double#NEGATIVE_INFINITY} is returned.
     * </p>
     *
    ...
    /**
     * Returns this JSON value as a <code>boolean</code> value, assuming that this value is either <code>true</code> or <code>false</code>. If this is not the
     ...
     *
     * Single elements are passed directly to the given writer. Therefore, if the writer is not buffered, wrapping it in a
     * {@link java.io.BufferedWriter BufferedWriter} can drastically improve writing performance.
     * </p>
     *
    ...
    /**
     * Returns the JSON string for this value in its minimal form, without any additional whitespace. The result is guaranteed to be a valid input for the
     * method {@link #readFrom(String)} and to create a value that is <em>equal</em> to this object.
     *
    ...
    /**
     * Indicates whether some other object is "equal to" this one according to the contract specified in {@link Object#equals(Object)}.
     *
     * Two JsonValues are considered equal if and only if they represent the same JSON text. As a consequence, two given JsonObjects may be different even
     * though they contain the same set of names with the same values, but in a different order.
     * </p>
     *
