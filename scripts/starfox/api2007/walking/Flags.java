...
public class Flags {
    ...
    public static final int[] WALL_BLOCKS = {WALL_BLOCK_NORTHWEST, WALL_BLOCK_NORTH, WALL_BLOCK_NORTHEAST, WALL_BLOCK_EAST, WALL_BLOCK_SOUTHEAST, WALL_BLOCK_SOUTH,
        WALL_BLOCK_SOUTHWEST, WALL_BLOCK_WEST};
