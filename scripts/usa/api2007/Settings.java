...
/**
 * The Settings class is a utility class that provides methods related to game
 * settings.
 *
 * @author Nolan
 */
public class Settings {
	...
	/**
	 * Gets the bits in between the start and end bit (inclusive) of the
	 * specified value.
	 *
	 * Bit position is read from right to left starting at zero and ending at
	 * the values binary length - 1.
	 *
	 * @param value
	 *            The value.
	 * @param startBit
	 ...
	 *
	 * This method treats bit location as if it was read from right to left
	 * starting at zero and ending at the values binary length - 1.
	 *
	 * @param value
	 *            The value.
	 * @param bit
