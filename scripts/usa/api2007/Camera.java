 ...
 */
public class Camera extends org.tribot.api2007.Camera {
	...
	/**
	 * Adjusts the camera to the target. The camera angle will be lower the
	 * further the player is away from the target.
	 * 
	 * @param asynchronous
	 * @param tile
	 * @return
	...
	/**
	 * Generates an angle 6 degrees lower for each tile from the target. Returns
	 * an angle between 33 and 100 degrees.
	 * 
	 * @param tile
	 * @return
	 */
